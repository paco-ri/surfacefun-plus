function [quadforest,C,L_max] = example_quadforest_1()
...
for i = 1:12
    ...
    elseif i == 10
        quadforest{10}{1} = uint64([0b00 0b01]);
        quadforest{10}{2} = uint64([0b1000 0b1010 0b1011 0b1100 0b1101 0b1110 0b1111]);
        quadforest{10}{3} = uint64([0b100100 0b100101 0b100110]);
        quadforest{10}{4} = uint64([0b10011100 0b10011101 0b10011110]);
        quadforest{10}{5} = uint64([0b1001111100 0b1001111101 0b1001111110 0b1001111111]);
        quadforest{10}{6} = uint64([]);
    else
