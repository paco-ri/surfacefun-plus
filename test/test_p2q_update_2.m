...
[x_fin22, y_fin22, z_fin22] = refine_patch(n, x_fin2{2}, y_fin2{2}, z_fin2{2});
dom.x{1} = x_fin{1};
dom.y{1} = y_fin{1};
dom.z{1} = z_fin{1};
dom.x{25} = x_fin2{1};
...
dom.z{30} = z_fin2{4};
for i = 1:3
    dom.x{30 + i} = x_fin22{i + 1};
    dom.y{30 + i} = y_fin22{i + 1};
    dom.z{30 + i} = z_fin22{i + 1};
end
